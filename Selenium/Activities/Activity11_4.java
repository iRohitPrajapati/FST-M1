...
public class Activity11_4 {
    public static void main(String[] args) {
        ...
        String newTabText = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("div.content"))).getText();
        ...
        //Get heading on new page
        newTabText = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("div.content"))).getText();
        System.out.println("New tab heading is: " + newTabText);
