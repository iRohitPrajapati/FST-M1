...
public class KeepReminder {
	...
	void googleKeep() throws InterruptedException {
		...
		Assert.assertTrue(reminder.getText().contains("Today"), "Do not add");
	}
...
//		driver.quit();
	...
	void setReminder(String time) {
		...
		List<MobileElement> listOpt = driver.findElementsByClassName("android.widget.TextView");
		for(MobileElement item:listOpt) {
